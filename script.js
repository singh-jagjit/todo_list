...
document.querySelector('#submit').addEventListener('click', () => {
  ...
  todo_done_el.classList.add('fa-sharp');
  ...
  let numb = document.querySelector('.todo-lists').childElementCount;
  const task_left = document.createElement('p');
  task_left.classList.add('text');
  task_left.type = 'text';
  task_left.value =  `${numb} tasks left`;
  task_left.setAttribute('readonly', 'readonly');
  document.appendChild(task_left);


});

document.querySelector('#submit_clear').addEventListener('click', () => {
    const myNode = document.querySelector('.todo-lists');
    myNode.innerHTML = '';
});
